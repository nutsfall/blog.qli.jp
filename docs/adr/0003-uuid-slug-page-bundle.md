...
- ステータス: 採用（slugの扱いは [#15](https://github.com/nutsfall/blog.qli.jp/issues/15) で再検討中）
...
- 一方でURLから記事内容が推測できない。人間可読なslugへの移行可否は [#15](https://github.com/nutsfall/blog.qli.jp/issues/15) で検討中（URL変更はリンク切れを伴うため慎重に）
